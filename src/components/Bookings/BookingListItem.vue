...
<template>
  <tr class="shadow-md">
    ...
    <td class="text-center">
      ...
      <template v-else>
        <button v-if="bookingType == BOOKING_TYPE_LAB" class="booking_modal_button" v-on:click="_handleOpenModal">
          See test results
        </button>
        <button v-if="bookingType == BOOKING_TYPE_DOCTOR" class="booking_modal_button" v-on:click="_handleOpenModal">
          See details
        </button>
      </template>
    </td>
